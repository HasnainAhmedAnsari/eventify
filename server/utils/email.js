...
exports.sendOTPEmail = async(userEmail, otp, type) =>{
    try{
        const title = type === 'account_verification' ? 'Verify your Eventify Account' : 'Eventify Booking Verifications';

        const msg = type === 'account_verification'
        ? 'Please use the following OTP to verify your new Eventify account'
        : 'Please use the following OTP to verify and confirm your Eventify booking';
